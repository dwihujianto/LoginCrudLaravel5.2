    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Tambah data dosen</div>

                <div class="panel-body">
                   {!! Form::open(['url' => route('dosen.store'),'class' => 'form-horizontal']) !!}
                   		
                   		<div class="form-group {{ $errors->has('_nik') ? 'has-error' : '' }}">
                   			
                   			{!! Form::label('Nik',null,['class' => 'col-sm-2 control-label']) !!}                  			
                   			<div class="col-md-5">
                   				{!! Form::text('_nik',null,['class' => 'form-control']) !!}
                   			</div>
                   		...
                   		<div class="form-group {{ $errors->has('_nama') ? 'has-error' : '' }}">
                   			...
                   			<div class="col-md-6">
                   				{!! Form::text('_nama',null,['class' => 'form-control']) !!}
                   			</div>
                   		...
                   		<div class="form-group {{ $errors->has('_jenkel') ? 'has-error' : '' }}">
                   			...
                   			<div class="col-md-6">
                   				{!! Form::radio('_jenkel','L') !!} Laki - laki
                   				{!! Form::radio('_jenkel','p') !!} Perempuan
                   			</div>
                   		...
                   		<div class="form-group {{ $errors->has('_alamat') ? 'has-error' : '' }}">
                   			...
                   			<div class="col-md-6">
                   				{!! Form::textarea('_alamat',null,['class' => 'form-control','size' => '30x5']) !!} 
                   			</div>
                   		...
                   		<div class="form-group {{ $errors->has('_agama') ? 'has-error' : ''}}">
                   			...
                   			<div class="col-md-4">
                   				{!! Form::select('_agama',$agamas,null,['placeholder' => 'Pilih','class' => 'form-control']) !!} 
                   			</div>
                   		...
                   		<div class="form-group {{ $errors->has('_bidang') ? 'has-error' : '' }}">
                   			...
                   			<div class="col-md-4">
                   				{!! Form::select('_bidang',$matkuls,null,['placeholder' => 'Pilih','class' => 'form-control']) !!} 
                   			</div>
